  ...
  return (
    <div className="p-6 py-16  flex flex-col justify-center items-center z-30">
     ...
     <div className='w-[550px] fixed right-[-250px] top-32 z-10'>
      ...
      <h1 className="text-4xl font-semibold mb-16">Select a Service</h1>
      <ul className='grid grid-cols-3 gap-3 z-30'>
        {services.length > 0 ? (
          services.map((service) => (
            <li
              key={service.id}
              onClick={() => setSelectedService(service.id)}
              className={`mb-2 p-2 border rounded-lg shadow-md z-30 ${
      ...
      <button
        ...
        className={`h-8 z-30 flex justify-center items-center fixed top-[520px] rounded-lg text-white text-sm duration-300 w-1/3 ${
