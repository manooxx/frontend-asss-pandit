...
<div className='w-full rounded-lg px-2  flex justify-between items-center fixed top-1 border bg-red-600 h-12 z-40'>
      ...
      <IoMdArrowBack />
            ...
            <div>
                ...
                <img className= 'fixed  drop-shadow-xl w-[1200px] h-[550px] top-0 left-0 z-30' src="./Images/final.png" alt="" />
                <img className='fixed opacity-70 right-[-190px] top-[-100px] z-10' src="https://s3-alpha-sig.figma.com/img/8995/10f6/5efd349079a91edc875a4766c9f16ae8?Expires=1730073600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Fd-UHyBxHgKqTau-cGaCiGmHdXN8ulsa3Q1NzLPOiFEzWS-vae-99Ntu4PU~TvpqIX5ac4kBU5gFRyT~gQeaKclTP1dXk4KMmQAbUbrs56cZFNSeMW2to9lx8XJuUjAkkUpxQGL42J0mWPgmtdUIZgSmllQI3fb~VL5VkO9TMlzoGgGps-Z~a4rUN3TGIlIfTFZGBV99t4XKODMrcXWEJgoKQRxernto1FKh36-df4ecm5XkGDPZViBrIfPaz1cFxEOPQjDIKNYSyJ8HIGBLBakYhtt9WDucy4tC~BSAJ7SM1K09xZVvxOoylLKvyc~JbepN2ottFixRytIsjaJJgw__" alt="" />
            </div>
            
          <div className=" flex flex-col fixed justify-center items-center top-[140px] p-6 rounded  w-96 z-30 gap-4">
            ...
            <form className=' flex flex-col gap-2' onSubmit={handleSaveProfile}>
              <input
                type="text"
                placeholder="First Name"
                value={firstName}
                onChange={(e) => setFirstName(e.target.value)}
                className="w-[300px]  px-2 p-1 outline-none border border-black  rounded"
              />
              <input
                type="text"
              ...
              <input
                ...
                className="w-[300px]  border-black  px-2 p-1 outline-none border  rounded"
              />
