...
const PanditProfilePage = () => {
  ...
  return (
        ...
        <div className="relative flex w-screen   justify-center items-center h-screen bg-gray-100 overflow-hidden">
...
<div className='w-full rounded-lg px-2  flex justify-between items-center fixed top-1 border bg-red-600 h-12 z-40'>
        ...
        <div className='absolute top-[75px] left-2 text-xl  cursor-pointer '>
      <IoMdArrowBack onClick={handleBack} />
            ...
            <div>
                ...
                <img className= 'absolute  drop-shadow-xl  md:w-full h-[690px] md:h-[600px] top-0 left-0 z-30' src="./Images/final.png" alt="" />
